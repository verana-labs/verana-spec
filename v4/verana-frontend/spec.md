...
- [VFE-PAGE-NAV-1] Primary navigation: **Dashboard**, **Account**, **Corporation**, **Ecosystems**, **Agents**, **Discover & Join**, **Pending Tasks** (with combined badge: pending validations + proposals awaiting the user's vote), **Settings**.
